...
[Micro SaaS focado em gerenciamento de aluguel de imóveis, com Front-End intuitivo, onde o dono de um ou vários imóveis de aluguel pode conferir as informações do inquilino. Tendo assim conhecimento sobre o quanto esse determinado inquilino deve pagar mensalmente, se seu aluguel está adiantado ou atrasado(calcular taxas), a localização do imóvel que o inquilino ocupa. Do lado de quem aluga, ele terá controle de quando e quanto pagar, além de o dono disponibilizar um horário de atendimento, para quaisquer informações que o inquilino queira saber sobre o imóvel, ou para relatar problemas encontrados no imóvel. Ademais sobre os pagamento, além de poder ver a data da mensalidade, o dono disponibiliza um método de pagamento, seja esse QR code ou chave pix, o inquilino os usa para pagar. Na parte do proprietário aparece uma notificação para a confirmação do pagamento, o proprietário confere no seu banco, confirmando assim, ou não, o pagamento.]
